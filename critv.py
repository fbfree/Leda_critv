...
# outputs KGsh, KGsvp
    ...
    for el in layers.values():
        try:
            if len(el) != nCp:
                print('Error: layers property dimensions mismatch')
                print('Lengths Cp: %d  Cs: %d  Dp: %d  Ds: %d  rho: %d  h: %d' % (nCp, len(layers['Cs']), len(layers['Dp']), len(layers['Ds']), len(layers['rho']), len(layers['h'])))
                raise RuntimeError
        except TypeError: # Ignore if an element el isn't iterable.
            continue
...
if __name__ == '__main__':
    ...
    gloucester_UIC60 = {'Cp': [4720.0,1348.0,300.0,200.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,120.0,75.0,60.0,79.0,79.0,95.0,120.0,135.0,170.0],
        ...
        'rho' : [7700.0,1100.0,2000.0,1400.0,1670.0,1570.0,1700.0,1550.0,1550.0,1580.0,1710.0,2000.0],
        'h' : [0.0595,0.121,0.6,0.6,2.0,2.0,3.0,2.0,2.0,3.0,3.0,numpy.inf],
        'i' : 4}
    ...
    # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 10m.
    beauharnois_UIC60_10m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0,75.0,79.0,83.0,89.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0,1690.0,1750.0],
        'h' : [0.0595,0.121,0.6,0.6,1.0,4.0,2.0,1.0,1.0],
    ...
    # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 8m.
    beauharnois_UIC60_8m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0,75.0,79.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0],
        'h' : [0.0595,0.121,0.6,0.6,1.0,4.0,2.0],
    ...
    # Same as beauharnois_UIC60_degraded with clay laying on stiff bedrock at a depth of 6m.
    beauharnois_UIC60_6m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0,75.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0],
        'h' : [0.0595,0.121,0.6,0.6,1.0,4.0],
    ...
    # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 5m.
    beauharnois_UIC60_5m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0,75.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0],
    ...
    # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 4m.
    beauharnois_UIC60_4m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0,75.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0],
        ...
        # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 3m.
    beauharnois_UIC60_3m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0],
        'h' : [0.0595,0.121,0.6,0.6,2.0],
        'i' : 4}

        # Same as beauharnois_UIC60 with clay laying on stiff bedrock at a depth of 2m.
    beauharnois_UIC60_2m = {'Cp': [4720.0,1348.0,300.0,163.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,100.0,75.0],
        'Dp' : [0.0001,0.1,0.05,0.005,0.002],
        'Ds' : [0.0001,0.1,0.05,0.005,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0],
    ...
    # Beauharnois clay remediated with concrete to 100 MPa shear modulus at given depth.
    beauharnois_UIC60_remediated4m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,75.0,79.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,3.0,2.0,2.0,1.0,1.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    beauharnois_UIC60_remediated3m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,75.0,79.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,2.0,3.0,2.0,1.0,1.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    beauharnois_UIC60_remediated2m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,75.0,79.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
    ...
    beauharnois_UIC60_remediated5m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,75.0,79.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1620.0,1640.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,4.0,1.0,2.0,1.0,1.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    beauharnois_UIC60_remediated6m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,79.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1640.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,5.0,2.0,1.0,1.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    beauharnois_UIC60_remediated8m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,83.0,89.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1690.0,1750.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,7.0,1.0,1.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    beauharnois_UIC60_remediated10m = {'Cp': [4720.0,1348.0,300.0,1500.0,1500.0,1500.0,1500.0,1500.0,1500.0],
        'Cs' : [2550.0,46.2,197.0,232.0,248.0,95.0,100.0,104.0,110.0],
        'Dp' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002],
        'Ds' : [0.0001,0.1,0.05,0.002,0.002,0.002,0.002,0.002,0.002],
        'rho' : [7700.0,1100.0,2000.0,1850.0,1620.0,1800.0,1850.0,1900.0,1940.0],
        'h' : [0.0595,0.121,0.6,0.6,9.0,2.0,2.0,4.0,numpy.inf],
        'i' : 6}

    layers = beauharnois_UIC60_remediated10m
    outfile = open('beauharnois_UIC60_remediated10m.dat','w')
    # generate_dispersion(layers,numpy.arange(0.5,100.0*2.0*3.14159,0.5),outfile)
    # outfile.close()
    period = 25.8 # metres
    k = numpy.concatenate([numpy.arange(0,5.1,2*3.14159/period),numpy.arange(-2*3.14159/period,-5.1,-2*3.14159/period)])
    ...
    source[1:k.shape[0]//2,1] = 15000*9.8/2.59*(numpy.exp(2.5j*k[1:k.shape[0]//2])+1.0)*(numpy.exp(8.4j*k[1:k.shape[0]//2])+1.0) # For use with layers including a steel rail in the top layer.   Two 15 tonne bogies spaced 2.5 m apart every 17.4 metres and 8.4 metres with 2.59 m wide stiff ties.
